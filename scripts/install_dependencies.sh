...
# Installs Apache HTTP server - this is like the front desk receptionist for our web application.
...
# The lines between <VirtualHost *:80> and </VirtualHost> create a configuration file for Apache to act as a reverse proxy for Tomcat. 
# This is like telling Apache: "When visitors come to our website, don't talk to them directly - 
# instead, silently pass their requests to Tomcat who's running our actual application."
